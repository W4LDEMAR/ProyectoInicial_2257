...
public class AltaEmpleado extends javax.swing.JFrame {
    ...
    private void jButton6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton6MouseClicked
        ...
        System.out.println("Empleado en el ARRGLO = " + lista);
        limpiarFormulario();
        jButton6.setEnabled(false);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // TODO add your handling code here:
        int respuesta = JOptionPane.showConfirmDialog(this, "Esta accion borrará los datos actuales. ¿Deseas continuar?");
        if (respuesta == 0) {
            ArchivoEmpleado persistencia = new ArchivoEmpleado();
            JFileChooser jfc = new JFileChooser();
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        //No se ha hecho control de tamaño
        if (this.indice < this.lista.size() - 1) {
            this.indice++; //Es el inidice más 1
        } else{
            this.indice = 0;
        }
